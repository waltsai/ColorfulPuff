...
public class PuffEntity extends AbstractPuffEntity {
    ...
    private void reinitializeBrain(ServerWorld world) {
        ...
        PuffBrain.create(this, this.getBrain());
    ...
    public float getScaleFactor() {
        if(this.isBaby()) {
            return this.getClothType() == ClothType.HONEY ? 0.66F * 0.909F : 0.66F;
        } else {
            return this.getClothType() == ClothType.HONEY ? 0.88F * 0.909F : 0.88F;
        }
    }
    ...
    public float getPathfindingFavor(BlockPos pos, WorldView world) {
        ...
        if (PuffBrain.isDangerousBlockAround(this, pos)) {
            return -1.0F;
        } else {
            return 0.0F;
        }
    ...
    public static TagKey<Item> getPuffTemptedItem(PuffEntity entity) {
        if (false && !entity.isBaby()) {
            ...
            if (entity.getPersonality() == PersonalityType.VIVID) {
                return ModProvider.VIVID_PUFF_TEMPTED_ITEM;
            }
            if (entity.getPersonality() == PersonalityType.DIGNIFIED) {
                return ModProvider.DIGNIFIED_PUFF_TEMPTED_ITEM;
            }
            if (entity.getPersonality() == PersonalityType.TIMID) {
                return ModProvider.TIMID_PUFF_TEMPTED_ITEM;
            }
        }
        return null;
    }
    ...
    public static TagKey<Item> getPuffTamedItem(PuffEntity entity) {
        if (false && !entity.isBaby()) {
            ...
            if (entity.getPersonality() == PersonalityType.VIVID) {
                return ModProvider.VIVID_PUFF_TAMED_ITEM;
            }
            if (entity.getPersonality() == PersonalityType.DIGNIFIED) {
                return ModProvider.DIGNIFIED_PUFF_TAMED_ITEM;
            }
            if (entity.getPersonality() == PersonalityType.TIMID) {
                return ModProvider.TIMID_PUFF_TAMED_ITEM;
            }
        }
        return null;
    }
