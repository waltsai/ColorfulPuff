...
public class PuffWalkTowardsTask extends Task<AbstractPuffEntity> {
    ...
    private void giveUp(AbstractPuffEntity puff, long time) {
    ...
    protected void run(ServerWorld serverWorld, AbstractPuffEntity puffEntity, long l) {
    ...
    private boolean shouldGiveUp(ServerWorld world, AbstractPuffEntity puff) {
    ...
    private boolean exceedsMaxRange(AbstractPuffEntity puff, GlobalPos pos) {
    ...
    private boolean reachedDestination(ServerWorld world, AbstractPuffEntity puff, GlobalPos pos) {
